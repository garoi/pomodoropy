...
def Notification(title, body, wtitle="Pomodoro timer", mode="notification-message-email"):
    if not pynotify.init(wtitle):
        sys.exit(1)
    initCaps()
    n = pynotify.Notification(title, body, mode)
    n.show()
